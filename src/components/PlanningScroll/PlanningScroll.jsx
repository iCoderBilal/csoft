  ...
  return (
    ...
    <div className="container px-5 mx-auto">
      <div className="lg:grid grid-cols-2 gap-4 items-start"  id="about">
        <div className="about-section-heading" data-scroll data-scroll-sticky data-scroll-target="#about">
